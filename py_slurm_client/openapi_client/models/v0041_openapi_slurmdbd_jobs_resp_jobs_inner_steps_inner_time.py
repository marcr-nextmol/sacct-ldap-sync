...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime(BaseModel):
    ...
    system: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeSystem] = None
    total: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal] = None
    user: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "system": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "total": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
