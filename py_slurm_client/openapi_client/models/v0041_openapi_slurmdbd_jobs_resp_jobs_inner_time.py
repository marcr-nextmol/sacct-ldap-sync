...
class V0041OpenapiSlurmdbdJobsRespJobsInnerTime(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "system": V0041OpenapiSlurmdbdJobsRespJobsInnerTimeSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "limit": SlurmV0041PostJobSubmitRequestJobsInnerTimeLimit.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
            "total": V0041OpenapiSlurmdbdJobsRespJobsInnerTimeTotal.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0041OpenapiSlurmdbdJobsRespJobsInnerTimeUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
