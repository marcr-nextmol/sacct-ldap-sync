...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatistics(BaseModel):
    ...
    """ # noqa: E501
    cpu: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsCPU] = Field(default=None, alias="CPU")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CPU": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsCPU.from_dict(obj["CPU"]) if obj.get("CPU") is not None else None,
