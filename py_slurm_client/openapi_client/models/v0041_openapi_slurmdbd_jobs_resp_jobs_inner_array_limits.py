...
class V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimits(BaseModel):
    """
    V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimits
    """ # noqa: E501
    max: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMax] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMax.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
