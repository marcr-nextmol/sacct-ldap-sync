...
class V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMax(BaseModel):
    """
    V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMax
    """ # noqa: E501
    running: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMaxRunning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "running": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayLimitsMaxRunning.from_dict(obj["running"]) if obj.get("running") is not None else None
        })
        return _obj
