...
slurm_v0041_post_job_submit_request_jobs_inner_rlimits_data_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerRlimitsData.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_rlimits_data_dict)
```
