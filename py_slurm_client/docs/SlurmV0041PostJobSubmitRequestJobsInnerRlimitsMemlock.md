...
slurm_v0041_post_job_submit_request_jobs_inner_rlimits_memlock_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerRlimitsMemlock.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_rlimits_memlock_dict)
```
