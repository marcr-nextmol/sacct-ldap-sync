...
slurm_v0041_get_diag200_response_statistics_req_time_from_dict = SlurmV0041GetDiag200ResponseStatisticsReqTime.from_dict(slurm_v0041_get_diag200_response_statistics_req_time_dict)
```
