...
slurm_v0041_get_shares200_response_shares_shares_inner_tres_run_seconds_inner_from_dict = SlurmV0041GetShares200ResponseSharesSharesInnerTresRunSecondsInner.from_dict(slurm_v0041_get_shares200_response_shares_shares_inner_tres_run_seconds_inner_dict)
```
