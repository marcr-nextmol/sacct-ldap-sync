...
slurm_v0041_post_job_submit_request_jobs_inner_segment_size_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerSegmentSize.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_segment_size_dict)
```
