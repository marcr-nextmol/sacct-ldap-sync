...
slurm_v0041_post_job_submit_request_jobs_inner_rlimits_fsize_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerRlimitsFsize.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_rlimits_fsize_dict)
```
