...
slurm_v0041_post_job_submit_request_jobs_inner_distribution_plane_size_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerDistributionPlaneSize.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_distribution_plane_size_dict)
```
