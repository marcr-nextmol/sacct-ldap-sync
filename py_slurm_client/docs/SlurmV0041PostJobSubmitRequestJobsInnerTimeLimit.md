...
slurm_v0041_post_job_submit_request_jobs_inner_time_limit_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerTimeLimit.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_time_limit_dict)
```
