...
class InlineObject(object):
    ...
    @property
    def users(self):
        """Gets the users of this InlineObject.  # noqa: E501


        :return: The users of this InlineObject.  # noqa: E501
        :rtype: list[NewSlurmUser]
        """
        return self._users

    @users.setter
    def users(self, users):
        """Sets the users of this InlineObject.


        :param users: The users of this InlineObject.  # noqa: E501
        :type: list[NewSlurmUser]
        """
