...
class Configuration(object):
    ...
    def __init__(self, host="http://localhost:6820/slurm/v0.0.41",
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://localhost:6820/slurm/v0.0.41",
                'description': "Development Slurm REST API server (adjust as needed)",
            }
        ]
