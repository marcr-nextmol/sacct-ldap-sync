...
slurm_v0041_post_job_submit_request_jobs_inner_time_minimum_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerTimeMinimum.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_time_minimum_dict)
```
