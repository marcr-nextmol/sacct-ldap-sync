...
slurm_v0041_post_job_submit_request_jobs_inner_rlimits_as_from_dict = SlurmV0041PostJobSubmitRequestJobsInnerRlimitsAs.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_rlimits_as_dict)
```
