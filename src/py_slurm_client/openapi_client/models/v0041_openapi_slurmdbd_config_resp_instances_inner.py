...
class V0041OpenapiSlurmdbdConfigRespInstancesInner(BaseModel):
    ...
    time: Optional[V0041OpenapiSlurmdbdConfigRespInstancesInnerTime] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time": V0041OpenapiSlurmdbdConfigRespInstancesInnerTime.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
        return _obj
