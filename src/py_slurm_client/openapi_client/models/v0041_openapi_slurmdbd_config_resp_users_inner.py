...
class V0041OpenapiSlurmdbdConfigRespUsersInner(BaseModel):
    ...
    default: Optional[V0041OpenapiSlurmdbdConfigRespUsersInnerDefault] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default": V0041OpenapiSlurmdbdConfigRespUsersInnerDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "flags": obj.get("flags"),
            "name": obj.get("name"),
